...
mod test_serde_type_support {
    ...
    fn test_serialize_fga() {
        let fga = FieldGoalAttempts(15);

        let json_str = serde_json::to_string(&fga).expect("couldn't serialize field goal attempts. ");
    ...
    fn test_serialize_fta() {
        let fta = FreeThrowAttempts(4);

        let json_str = serde_json::to_string(&fta).expect("couldn't serialize free throw attempts. ");
    ...
    fn test_serialize_wl() {
        ...
        let json_str_l = serde_json::to_string(&loss).expect("couldn't serialize GameResult::Loss. ");
    ...
    fn test_serialize_matchup() {
        let sonics = MatchupString::from_matchup("SON".parse().unwrap(), "OKC".parse().unwrap(), Home);

        let bums = MatchupString::from_matchup("SON".parse().unwrap(), "OKC".parse().unwrap(), Away);

        let sonics_str = serde_json::to_string(&sonics).expect("couldn't serialize Sonic's matchup. ");

        let bum_str = serde_json::to_string(&bums).expect("couldn't serialize the BUMS's matchup. ");
    ...
    fn test_serialize_pf() {
        ...
        let json_str = serde_json::to_string(&personal_fouls).expect("couldn't serialize personal fouls. ");
    ...
    fn test_serialize_player_name() {
        ...
        let json_str = serde_json::to_string(&player_name).expect("couldn't serialize player_name. ");
    ...
    fn test_serialize_plus_minus() {
        ...
        let json_str_n = serde_json::to_string(&neg).expect("couldn't serialize negative plus minus. ");
        let json_str_p = serde_json::to_string(&pos).expect("couldn't serialize positive plus minus. ");
    ...
    fn test_serialize_oreb() {
        ...
        let json_str = serde_json::to_string(&oreb).expect("couldn't serialize offensive rebounds. ");
    ...
    fn test_serialize_dreb() {
        ...
        let json_str = serde_json::to_string(&dreb).expect("couldn't serialize defensive rebounds. ");
    ...
    fn test_serialize_team_abbr() {
        ...
        let json_str = serde_json::to_string(&assists).expect("couldn't serialize team abbreviation. ");
    ...
    fn test_serialize_fg3m() {
        ...
        let json_str = serde_json::to_string(&fg3m).expect("couldn't serialize three point makes. ");
    ...
    fn test_serialize_fg3a() {
        ...
        let json_str = serde_json::to_string(&fg3a).expect("couldn't serialize three point attempts. ");
